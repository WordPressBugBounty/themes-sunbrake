<?php
namespace SunbrakeTheme\SiteLeadsThemeKit;



use SunbrakeTheme\SiteLeadsThemeKit\Customizer\Sections\SiteLeadsSection;
use SunbrakeTheme\SiteLeadsThemeKit\Customizer\Controls\SiteLeadsIntegrationButton;
...
//        );
    ...
    public function enqueue_admin_scripts() {
        ...
        wp_add_inline_script(
            'jquery',
            sprintf(
                'window.sunbrakethemeSiteLeadsData = %s;',
    ...
    public static function printSiteLeadsRecommendationPlugins() {
        ?>
          <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__container">
              <span><?php echo esc_html(__('plugins', 'sunbrake')) ?></span>
              <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__content">
                            <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__item">
                                <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__item__title">
                                    <?php echo esc_html(__('Kubio Page Builder (free)', 'sunbrake'));?>
                                </div>
                                <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__item__description">
                                    <?php echo esc_html(sprintf(__('Adds drag and drop functionality and many other features to the %s theme.', 'sunbrake'),  static::get_current_theme_name()));?>
                                </div>
                            </div>

                            <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__item">
                                <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__item__title">
                                    <?php echo esc_html(__('SiteLeads (free)', 'sunbrake'))?>
                                </div>
                                <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__item__description">
                                    <?php echo esc_html(__('Get more leads from your site by adding popular contact channels: Whatsapp, Messenger, Phone, AI Assistant, etc.', 'sunbrake'))?>
                                </div>
                            </div>
    ...
    public static function getEnableAllThemeFeatureDescriptionText() {
        ...
        esc_html_e(
            sprintf(
                __('To enable all theme features, please Install the %s recommended', 'sunbrake'),
    ...
    public static function getInstallCompanioNoticeDescriptionInCustomizerWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation()) {
            ob_start();
            ?>
            <div class="sunbraketheme-install-plugin-description sunbraketheme-siteleads-recommendation-plugins-tooltip__wrapper--customizer-install-notice">
    ...
    public static function getInstallCompanioNoticeDescriptionInWPAdminWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation()) {
            ob_start();
            ?>
            <div class="sunbraketheme-siteleads-recommendation-plugins-tooltip__wrapper--customizer-install-notice description large-text">
                <?php
                esc_html_e(
                    sprintf(
                        __( 'This action will install the %s recommended', 'sunbrake' ),
                        SiteLeads::get_current_theme_name()
                    )
                );
                SiteLeads::printSiteLeadsRecommendationPlugins();
    ...
    public static function getInstallCompanionButtonLabelWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation() ) {
            return esc_html(__( 'Enable all theme features', 'sunbrake' ));
        } else {
            return esc_html(__( 'Install Kubio Page Builder', 'sunbrake' ));
        }
    }
    ...
    public static function getActivateCompanionButtonLabelWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation() ) {
            ...
            return esc_html(__( 'Activate Kubio Page Builder', 'sunbrake' ));
        }
    }
    public function print_call_icon_no_site_leads() {
        ...
        ?>
        <div class="sunbraketheme-siteleads-for-theme-root --sunbraketheme-siteleads-for-theme-root-alignment-right">
            <div class="sunbraketheme-siteleads-for-theme-root-inner">
                <div class="sunbraketheme-siteleads-for-theme-fc-widgets siteleads-fc-widgets">
                    <div class="sunbraketheme-siteleads-for-theme-widget --sunbraketheme-siteleads-for-theme-root-alignment-right --sl-simple-view --medium-size --has-attention-effect" style="--sl-full-fab-size: calc(var(--sl-base-fab-size) + 0px * 2 );--sl-fab-border-width: 0px; --sl-shadow-3:0px 3px 3px -2px rgba(0, 0, 0, 0.15), 0px 3px 4px 0px rgba(0, 0, 0, 0.105), 0px 1px 8px 0px rgba(0, 0, 0, 0.09)" data-widget-id="widget-1770032923949" data-view="simple" data-device="desktop" data-has-agent="false" data-single-channel="true">
                        <div class="sunbraketheme-siteleads-for-theme-widget__channels" style="grid-template-columns: 1fr;--desktop-widget-color: #029900;box-shadow: var(--sl-shadow-3);border-radius:100%">
                            <div class="sunbraketheme-siteleads-for-theme-channel__wrapper" style="color: red; --sl-icon-color: #029900; transition-duration: 0s; opacity: 1;">
                                <a class="sunbraketheme-siteleads-for-theme-channel sunbraketheme-siteleads-for-theme-channel__phone" rel="nofollow noopener" href="<?php echo esc_attr( $phone_link ); ?>" <?php echo esc_attr($extra_link_attributes); ?> data-channel="phone" style="color: #029900;border-radius: 100%;background-color: #029900;box-shadow: var(--sl-shadow-3);border-width: 0px;--sl-fab-border-width: 0px;border-color: #2363EB">
									<span class="sunbraketheme-siteleads-for-theme-channel__icon" style="color: #029900;background: var(--sl-icon-color, transparent);border-radius: 100%;box-shadow: var(--sl-shadow-3)">
    ...
    public function ajax_siteleads_plugin_toggle_enabled() {
        ...
        if ( ! current_user_can( 'edit_theme_options' ) ) {
            wp_send_json_error( __( 'Not allowed', 'sunbrake' ), 400 );
        }
        if ( ! $this->get_site_leads_plugin_is_active() ) {
            wp_send_json_error( __( 'Required plugin is missing', 'sunbrake' ), 400 );
        }
        if ( ! class_exists( '\SiteLeads\Features\Widgets\FCWidgetsManager' ) ||
            ...
            wp_send_json_error(__('Required class or functions are missing', 'sunbrake'), 400);
        }


        if ( ! isset( $_POST['enabled'] ) ) {
            wp_send_json_error( __( 'Missing required parameter: enabled', 'sunbrake' ), 400 );
        }
        if ( ! isset( $_POST['widget_id'] ) ) {
            wp_send_json_error( __( 'Missing required parameter: widget_id', 'sunbrake' ), 400 );
        }
        // Sanitize the input
        ...
        if ( empty( $widget_id ) || !is_string($widget_id)) {
            ...
            if(empty( $widget_id ) || !is_string($widget_id)) {
                wp_send_json_error( __( 'Missing widget id', 'sunbrake' ), 400 );
            }
    ...
    public function add_customizer_controls_and_settings( $wp_customize ) {
        ...
        $wp_customize->add_section(
            new SiteLeadsSection(
                ...
                array(
                    'title'    => __( 'Contact Settings', 'sunbrake' ),
                    'priority' => 9999,
                )
            )
        );
        ...
        $wp_customize->add_control(
            Theme::prefix( 'siteleads_number' ),
            array(
                'label'       => __( 'Phοne Number', 'sunbrake' ),
                'section'     => Theme::prefix( 'contact_settings' ),
                'type'        => 'text',
                'priority'    => 10,
        ...
        $wp_customize->add_control(
            Theme::prefix( 'show_contact_phone' ),
            array(
                'label'    => __( 'Show Contact Widget', 'sunbrake' ),
                'section'  => Theme::prefix( 'contact_settings' ),
                'type'     => 'checkbox',
                'priority' => 9,
    ...
    public function get_js_text_translations() {
        return array(
            'notice_title_not_installed'             => __( 'For more contact channels & settings, please install the', 'sunbrake' ),
            'notice_title_installed'             => __( 'For more contact channels & settings, please activate the', 'sunbrake' ),
            'notice_title_active'             => __( 'Contact channels & settings can be found inside the', 'sunbrake' ),

            'plugin_text'                      => __( 'plugin', 'sunbrake' ),



            'notice_description_1'             => __( 'SiteLeads adds popular contact channels to your site:', 'sunbrake' ),
            'notice_description_2'             => __( 'Whatsapp, Messenger, Phone, Email, AI Assistant, etc.', 'sunbrake' ),
            'notice_description_3'             => __( 'Visitors can easily reach you and you never miss a lead.', 'sunbrake' ),

            'info_notice_installing'            => __('Installing SiteLeads', 'sunbrake'),
            'info_notice_activating'            => __('Activating SiteLeads', 'sunbrake'),
            'info_notice_init'                  => __('Preparing SiteLeads', 'sunbrake'),


            'install_button_text_active_plugin'     => __( 'Manage Contact Widget', 'sunbrake' ),
            'install_button_text_installed_plugin'  => __( 'Activate SiteLeads', 'sunbrake' ),
            'install_button_not_installed_plugin'   => __( 'Install SiteLeads', 'sunbrake' ),

            'error_could_not_init_plugin_data'      => __( 'Could not initialise the SiteLeads plugin data', 'sunbrake' ),
            'error_could_not_install_plugin'        => __( 'Could not install the SiteLeads plugin', 'sunbrake' ),
            'error_could_not_activate_plugin'       => __( 'Could not activate the SiteLeads plugin', 'sunbrake' ),
            'error_could_not_toggle_plugin_enabled' => __( 'Could not toggle Siteleads plugin status', 'sunbrake' )
        );
    }
